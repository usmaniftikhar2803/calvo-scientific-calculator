...
const formulaData = {
  ...
  'Arts Mathematics': [
    { cat: 'Percentage', name: 'Percentage Formula', expr: 'P = (Value/Total) × 100' },
    { cat: 'Percentage', name: 'Percentage Increase', expr: '% Increase = ((New-Old)/Old) × 100' },
    { cat: 'Percentage', name: 'Percentage Decrease', expr: '% Decrease = ((Old-New)/Old) × 100' },
    { cat: 'Profit & Loss', name: 'Profit', expr: 'Profit = Selling Price − Cost Price' },
    { cat: 'Profit & Loss', name: 'Loss', expr: 'Loss = Cost Price − Selling Price' },
    { cat: 'Profit & Loss', name: 'Profit Percentage', expr: 'Profit% = (Profit/Cost Price) × 100' },
    { cat: 'Profit & Loss', name: 'Loss Percentage', expr: 'Loss% = (Loss/Cost Price) × 100' },
    { cat: 'Simple & Compound Interest', name: 'Simple Interest', expr: 'SI = (P × R × T) / 100' },
    { cat: 'Simple & Compound Interest', name: 'Compound Interest', expr: 'CI = P(1 + R/100)ᵀ − P' },
    { cat: 'Simple & Compound Interest', name: 'Amount (Simple)', expr: 'A = P + SI' },
    { cat: 'Ratio & Proportion', name: 'Ratio', expr: 'a : b = a/b' },
    { cat: 'Ratio & Proportion', name: 'Proportion', expr: 'a : b = c : d  ⟹  ad = bc' },
    { cat: 'Ratio & Proportion', name: 'Third Proportional', expr: 'a : b = b : x  ⟹  x = b²/a' },
    { cat: 'Averages', name: 'Average (Mean)', expr: 'Average = Sum of values / Number of values' },
    { cat: 'Averages', name: 'Average Speed', expr: 'Avg Speed = Total Distance / Total Time' },
    { cat: 'Time, Speed & Distance', name: 'Distance', expr: 'Distance = Speed × Time' },
    { cat: 'Time, Speed & Distance', name: 'Speed', expr: 'Speed = Distance / Time' },
    { cat: 'Time & Work', name: 'Work Rate', expr: 'Work Rate = 1 / Time taken to finish' },
    { cat: 'Time & Work', name: 'Combined Work', expr: '1/T = 1/T₁ + 1/T₂' },
    { cat: 'Mensuration (Basic)', name: 'Area of Rectangle', expr: 'A = length × width' },
    { cat: 'Mensuration (Basic)', name: 'Area of Square', expr: 'A = side²' },
    { cat: 'Mensuration (Basic)', name: 'Area of Triangle', expr: 'A = ½ × base × height' },
    { cat: 'Mensuration (Basic)', name: 'Area of Circle', expr: 'A = πr²' },
    { cat: 'Mensuration (Basic)', name: 'Perimeter of Rectangle', expr: 'P = 2(length + width)' },
    { cat: 'Mensuration (Basic)', name: 'Circumference of Circle', expr: 'C = 2πr' },
    { cat: 'Basic Algebra', name: 'Linear Equation', expr: 'ax + b = 0  ⟹  x = -b/a' },
    { cat: 'Basic Algebra', name: '(a + b)²', expr: 'a² + 2ab + b²' },
    { cat: 'Basic Algebra', name: '(a − b)²', expr: 'a² − 2ab + b²' },
    { cat: 'Basic Algebra', name: 'Difference of Squares', expr: 'a² − b² = (a+b)(a−b)' },
    { cat: 'Sets', name: 'Union of Sets', expr: 'A ∪ B = elements in A or B' },
    { cat: 'Sets', name: 'Intersection of Sets', expr: 'A ∩ B = elements in both A and B' },
    { cat: 'Sets', name: 'Number of Subsets', expr: 'Number of subsets = 2ⁿ' },
    { cat: 'Taxation & Discount', name: 'Discount Amount', expr: 'Discount = Marked Price − Selling Price' },
    { cat: 'Taxation & Discount', name: 'Discount Percentage', expr: 'Discount% = (Discount/Marked Price) × 100' },
    { cat: 'Taxation & Discount', name: 'Sales Tax', expr: 'Tax Amount = (Price × Tax Rate) / 100' },
  ],
